...
PROGRAMS = {
    'Preschool': {
        ...
        'skills': [
            ...
            {'event':'BARS', 'short':'FWD ROLL ●',   'criteria':['Unassisted front support for 3 sec','Looks at belly while rolling','Hands stay on bar until done']},
    ...
    'Junior': {
        ...
        'skills': [
            ...
            {'event':'FLOOR','short':'LUNGE → HANDSTAND (Mat Supported)',      'criteria':['Starts and finishes in a lunge','Straight legs, feet together at vert','Straight line from hands to toes']},
    ...
    'Advanced Junior': {
        ...
        'skills': [
            ...
            {'event':'BARS', 'short':'FS HOLD→FWD ROLL','criteria':['Holds front support, straight arms','Chin to chest','Legs straight, lowers slowly to hang']},
