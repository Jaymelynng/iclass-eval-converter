...
PROGRAMS = {
    ...
    # ── Boys programs (HGA-specific, single-bubble criteria, no 3+mastery breakdown) ──
    'Boys Level 1': {
        'has_safety': False,
        'footer_h': 18,
        'num_rows': 8,
        'skills': [
            {'event':'FLOOR','short':'Handstand',                          'criteria':['Handstand']},
            {'event':'FLOOR','short':'Cartwheel',                          'criteria':['Cartwheel']},
            {'event':'FLOOR','short':'Backward Roll\nto Feet',             'criteria':['Backward roll to feet','Proper hand placement']},
            {'event':'FLOOR','short':'Bridge',                             'criteria':['Bridge','Straight arms']},
            {'event':'FLOOR','short':'Forward Roll',                       'criteria':['Forward roll','Feet and knees together']},
            {'event':'FLOOR','short':'Round Off\nIntro',                   'criteria':['Round off introduction']},
            {'event':'MUSHROOM','short':'Walks\nArounds',                  'criteria':['Walks arounds']},
            {'event':'MUSHROOM','short':'Hop\nArounds',                    'criteria':['Hop arounds']},
            {'event':'MUSHROOM','short':'Swing 3/4',                       'criteria':['Swing 3/4']},
            {'event':'MUSHROOM','short':'Swing Full',                      'criteria':['Swing Full']},
            {'event':'VAULT','short':'Straight\nJump',                     'criteria':['Straight jump']},
            {'event':'VAULT','short':'Arm Circle',                         'criteria':['Arm circle']},
            {'event':'VAULT','short':'Hurdle\nPunch Board\nFwd Roll',      'criteria':['Hurdle - Punch board with 2 feet - Forward roll']},
            {'event':'VAULT','short':'Handstand\nFlatback',                'criteria':['Handstand Flatback']},
            {'event':'P BARS','short':'Monkey\nWalks',                     'criteria':['Monkey walks across bar']},
            {'event':'P BARS','short':'5 Swings\nin a Row',                'criteria':['5 swings in a row','Feet together']},
            {'event':'P BARS','short':'Forward\nSupport Walks',            'criteria':['Forward support walks']},
            {'event':'P BARS','short':'Straddle\nTravel',                  'criteria':['Straddle travel']},
            {'event':'BARS','short':'Casts',                               'criteria':['Casts (No Height Requirement)']},
            {'event':'BARS','short':'Fwd Roll to\nChin Hold',              'criteria':['Forward Roll to Chin Hold 3 seconds']},
            {'event':'BARS','short':'Kickover\nPullover',                  'criteria':['Kickover Pullover (No Chin Hold)']},
            {'event':'BARS','short':'Skin the Cat\nBwd & Fwd',             'criteria':['Skin the Cat Backward and Forward']},
        ],
    },
    'Boys Level 2': {
        'has_safety': False,
        ...
        'num_rows': 8,
        'skills': [
            {'event':'FLOOR','short':'Cartwheel\nStep-in',                 'criteria':['Cartwheel step-in - Hollow body']},
            {'event':'FLOOR','short':'Handstand\nFwd Roll',                'criteria':['Handstand forward roll']},
            {'event':'FLOOR','short':'Backward\nRoll',                     'criteria':['Backward roll','Proper hand placement']},
            {'event':'FLOOR','short':'Handstand\nHold 2 sec',              'criteria':['Handstand hold','2 second']},
            {'event':'FLOOR','short':'Handstand\nHold to Bridge',          'criteria':['Handstand hold','2 seconds - bridge']},
            {'event':'FLOOR','short':'Round Off',                          'criteria':['Round Off']},
            {'event':'POMMEL','short':'1/2 Double\nLeg Circle',            'criteria':['Mushroom - 1/2 double leg circle']},
            {'event':'POMMEL','short':'Swing Leg\n1/4 Circle',             'criteria':['Mushroom - Swing leg 1/4 circle']},
            {'event':'POMMEL','short':'5 Whole\nCircles',                  'criteria':['Mushroom','5 whole circles, feet in bucket']},
            {'event':'POMMEL','short':'Prone Horse\nSwings',               'criteria':['Prone horse swings','10 with outside leg']},
            {'event':'RINGS','short':'Pike Hold\n5 sec',                   'criteria':['Pike hold - 5 seconds, rings by ears']},
            {'event':'RINGS','short':'Swing Fwd\nInverted',                'criteria':['Swing forward - inverted hang position']},
            {'event':'RINGS','short':'Skin the Cat\nGerman Hang',          'criteria':['Skin the cat - German hang','3 seconds']},
            {'event':'VAULT','short':'Handstand\nFlatback',                'criteria':['Handstand flat back']},
            {'event':'VAULT','short':'Resi HS\nFwd Roll',                  'criteria':['Resi','Handstand forward roll, over cheese mat']},
            {'event':'P BARS','short':'L Support\nHold',                   'criteria':['L support hold ( 5 seconds)']},
            {'event':'P BARS','short':'Straddle\nTravel',                  'criteria':['Straddle travel','Straight legs']},
            {'event':'P BARS','short':'Straddle V\nSupport',               'criteria':['Straddle V support hold','5 seconds, legs in front']},
            {'event':'P BARS','short':'Support\nSwings',                   'criteria':['Support swings - Horizontal']},
            {'event':'P BARS','short':'Upper Arm\nSwing',                  'criteria':['Upper arm swing - Baby front up rise straddle']},
            {'event':'H BARS','short':'Tap Swing',                         'criteria':['Tap swing, straight legs']},
            {'event':'H BARS','short':'Back Hip\nCircle',                  'criteria':['Back hip circle, Assisted']},
        ],
    },
    'Boys Level 3': {
        'has_safety': False,
        ...
        'num_rows': 8,
        'skills': [
            {'event':'FLOOR','short':'Back\nHandspring',                   'criteria':['Back handspring']},
            {'event':'FLOOR','short':'Round Off\nRebound',                 'criteria':['Round off - rebound']},
            {'event':'FLOOR','short':'Backbend\nKickover',                 'criteria':['Backbend kick over']},
            {'event':'FLOOR','short':'Front\nLimber',                      'criteria':['Front limber']},
            {'event':'FLOOR','short':'Front\nWalkover',                    'criteria':['Front walkover','Straight arms, legs']},
            {'event':'FLOOR','short':'Handstand\nBlock',                   'criteria':['Handstand block','Straight arms']},
            {'event':'FLOOR','short':'Handstand\nSnap Rebound',            'criteria':['Handstand snap - Rebound']},
            {'event':'POMMEL','short':'3/4 Double\nLeg Circle',            'criteria':['Mushroom - 3/4 double leg circle']},
            {'event':'POMMEL','short':'Circle\n(Assisted)',                 'criteria':['Mushroom - Circle (assisted)']},
            {'event':'POMMEL','short':'10 Whole\nCircles',                 'criteria':['Mushroom','10 whole circles, feet in bucket']},
            {'event':'POMMEL','short':'Prone Horse\nSwings',               'criteria':['Prone horse swings','5 inside swings, both legs']},
            {'event':'RINGS','short':'5 Swings\nShifting',                 'criteria':['5 swings in a row, shifting rings - proper form']},
            {'event':'RINGS','short':'Pike Inverted\nto Back Lever',       'criteria':['Pike inverted hang - Extend to back lever - German hang']},
            {'event':'RINGS','short':'Tuck Support\nto L Support',         'criteria':['Tuck support hold - Extend to L support - return']},
            {'event':'VAULT','short':'Resi HS\nFlatback',                  'criteria':['Resi - Handstand flat back, arm circle - proper form']},
            {'event':'VAULT','short':'Front HS\n(Assisted)',                'criteria':['Vault table','Front handspring, Assisted']},
            {'event':'P BARS','short':'Support\nHalf Turn',                'criteria':['Support - Half turn - Support']},
            {'event':'P BARS','short':'Support\nSwings',                   'criteria':['Support swings above horizontal']},
            {'event':'P BARS','short':'Straddle\nSupport',                 'criteria':['Straddle support, Assisted']},
            {'event':'P BARS','short':'Support\nHops',                     'criteria':['Support hops','Forwards, backwards']},
            {'event':'H BARS','short':'5 Top\nSwings',                     'criteria':['High bar - 5 top swings']},
            {'event':'H BARS','short':'Back Hip\nCircle',                  'criteria':['Back hip circle','Hollow body, wrist shift']},
            {'event':'H BARS','short':'Cast Straddle\nDismount',           'criteria':['Cast - Straddle swing - Dismount']},
        ],
    },
}
